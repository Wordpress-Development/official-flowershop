							...
							<header class="entry-header">
								...
								<div class="entry-meta">
									<?php
										...
										printf(__('Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>', 'official-flowershop'),
								...
								<ul role="navigation" id="image-navigation" class="image-navigation pager">
									<li class="nav-previous previous"><?php previous_image_link(false, __('<span class="meta-nav">&larr;</span> Previous', 'official-flowershop')); ?></li>
									<li class="nav-next next"><?php next_image_link(false, __('Next <span class="meta-nav">&rarr;</span>', 'official-flowershop')); ?></li>
								</ul><!-- #image-navigation -->
							</header><!-- .entry-header -->
							...
							<div class="entry-content">
								<div class="entry-attachment">
									<div class="attachment">
										<?php official_flowershop_TheAttachedImage(); ?> 
									</div><!-- .attachment -->
