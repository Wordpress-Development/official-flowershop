...
function officialtheme_widgets_area() {
...
add_action('widgets_init', 'officialtheme_widgets_area');



// Bootstrap row-count for some widgets
function en_widget_cownt($params) {
...
add_filter('dynamic_sidebar_params','en_widget_cownt');
