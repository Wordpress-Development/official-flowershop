...
if (!function_exists('officialtheme_columns_size_sidebars')) {
	/**
	 ...
	 */
	function officialtheme_columns_size_sidebars() 
	{
		if (is_active_sidebar('en_widgets_area_sidebar_left') && is_active_sidebar('en_widgets_area_sidebar_right')) {
			// if both sidebar actived.
			$main_column_size = 6;
		} elseif (
				(is_active_sidebar('sen_widgets_area_sidebar_left') && !is_active_sidebar('en_widgets_area_sidebar_right')) || 
				(is_active_sidebar('en_widgets_area_sidebar_right') && !is_active_sidebar('en_widgets_area_sidebar_left'))
		) {
